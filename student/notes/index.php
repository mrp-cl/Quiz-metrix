        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-8">
                ...
                <div id="note-expanded" class="card shadow-sm d-none">
                    <div class="card-body">
                        <input type="text" id="note-title" class="form-control border-0 fw-bold mb-2" placeholder="Title">
                        <textarea id="note-content" class="form-control border-0" placeholder="Take a note..."></textarea>
